...
export default function Restaurant(props) {
    ...
    //navigation.setOptions({ title: name }); "" ojo => meter esta linea de codigo en useEffect""

    //useEffect(() => {//ojo no sirve
    ...
    useFocusEffect(
        useCallback(() => {// se modifico el codigo con el video 153
            setRestaurant(null)
...
function RestaurantInfo(props) {
    ...
    const listInfo = [
        ...
        /* Si hubiera mas informacion se lo añade lo que esta en el comentario */
        {
            text: "78754519",
            iconName: "phone",
            iconType: "material-community",
