...
export default function Favorites(props) {
    ...
    const [restaurants, setRestaurants] = useState(null);//=>"OJO"Una solucion de muchas (se cambio null por un array vacio)
    ...
    firebase.auth().onAuthStateChanged((user) => { // devuelve el usuario
